	...
	public class FereastraPrincipala extends JFrame{
		...
		ArrayList<Student> listaMutati = new ArrayList<Student>();
		...
		public FereastraPrincipala() {
			...
			btnNewButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {				
							...
							Student mutat = (Student) list.getSelectedValue();
							int index = list.getSelectedIndex();
							listaMutati.add(mutat);
							listOfStudents.remove(index);
							rewriteStudentList(listaMutati, list_1);
							rewriteStudentList(listOfStudents, list);
